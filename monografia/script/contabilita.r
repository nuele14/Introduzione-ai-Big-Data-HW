...
#medie per mese
ggplot(media_mesi, aes(x = data_formattata, y = vendite_medie, group = 1,)) +
 geom_line() + geom_point() + ggtitle("Medie per Mese") +
  geom_hline(yintercept = media_generale, color = "red", linetype = "dashed", size = 1) +
  theme(axis.text.x = element_text(angle = 90, hjust = 1)) +
  labs(x = "Date", y = " Importo medio")
...
#migliori mesi
ggplot(mesi_max, aes(x = data_formattata, y = vendite_totali)) +
geom_bar(stat = "identity", fill = "green", position = position_dodge(width = 0.8)) +
labs(title = "Miglior mese per anno",
       x = "Data",
       y = "Fatturato") + theme(axis.text.x = element_text(angle = 90, hjust = 1)) +
       geom_hline(yintercept = media_generale, color = "red", linetype = "dashed", size = 1)
#peggiori mesi
ggplot(mesi_min, aes(x = data_formattata, y = vendite_totali)) +
geom_bar(stat = "identity", fill = "blue", position = position_dodge(width = 0.8)) +
labs(title = "Peggior mese per anno",
       x = "Data",
       y = "Fatturato")  + theme(axis.text.x = element_text(angle = 90, hjust = 1)) +
       geom_hline(yintercept = media_generale, color = "red", linetype = "dashed", size = 1)
